...
const EmployeeFormContext = createContext<
  ReturnType<typeof useEmployeeForm> | undefined
>(undefined);

export const EmployeeFormProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
...
export const useEmployeeFormContext = () => {
  ...
  if (context === undefined) {
    throw new Error(
      "useEmployeeFormContext must be used within an EmployeeFormProvider"
    );
  }
  return context;
};
