...
const NotificationDetail: React.FC<NotificationDetailProps> = ({
  ...
  const { employeeDetails, isLoading, error } =
    useNotificationEmployee(notification);
                ...
                <div className="bg-[#222222] p-4 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2">
                      ...
                      <span className="text-white">
                        {employeeDetails.officeLocation || "N/A"}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#222222] p-4 rounded-lg">
                  ...
                  <div className="space-y-2">
                    <div className="grid grid-cols-2">
                      ...
                      <span className="text-white">
                        {employeeDetails.slackId || "N/A"}
                      </span>
                    </div>
                    <div className="grid grid-cols-2">
                      <span className="text-gray-400">Skype ID</span>
                      <span className="text-white">
                        {employeeDetails.skypeId || "N/A"}
                      </span>
                    </div>
                    <div className="grid grid-cols-2">
                      <span className="text-gray-400">GitHub ID</span>
                      <span className="text-white">
                        {employeeDetails.githubId || "N/A"}
                      </span>
                    </div>
                    <div className="grid grid-cols-2">
                      <span className="text-gray-400">Username</span>
                      <span className="text-white">
                        {employeeDetails.userName || "N/A"}
                      </span>
                    </div>
                  </div>
                </div>
